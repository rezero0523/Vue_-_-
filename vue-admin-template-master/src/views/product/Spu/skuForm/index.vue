<template>
  <div>
    <el-form ref="form" label-width="80px" value="">
      <el-form-item label="SPU名称"> {{spu.spuName}} </el-form-item>
      <el-form-item label="SKU名称">
        <el-input placeholder="sku名称" type="number" v-model="skuInfo.skuName"></el-input>
      </el-form-item>
      ...
      <el-form-item label="销售属性">
        <el-form :inline="true" ref="form" label-width="80px">
          <el-form-item :label="saleAttr.saleAttrName" v-for="(saleAttr, index) in spuSaleAttrList" :key="saleAttr.id">
            <el-select placeholder="请选择"  v-v-model="saleAttr.attrIdAndValueId">
        ...
        <el-table style="width: 100%" border :data="spuImageList" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="prop" label="操作" width="width">
            <template slot-scope="{row,$index}">
                ...
                <el-button v-if="row.isDefault==1">默认 </el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
